describe('Tainacan Plugin Test', function () {
  ...
  context('Fields', function(){
    it('create field', function(){
      ...
      cy.visit('/wp-admin/admin.php?page=tainacan_admin#/collections/28/fields/')
      cy.get('.field > .columns > :nth-child(1) > :nth-child(1)').scrollIntoView('left')
    })
  })
})
